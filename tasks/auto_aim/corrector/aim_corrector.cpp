...
#include "tasks/auto_aim/corrector/detect_bullet.hpp"
#include "tasks/auto_aim/corrector/do_reproj.hpp"
#include "tasks/auto_aim/corrector/coord_converter.hpp"
...
auto AimCorrector::sample_aim_errors() -> void {
    ...
    for (const auto& bullet: this->bullets) {
        ...
        if (best_bullet != undistorted_detected.end()) {
            ...
            //aimer::debug::flask_aim << aimer::debug::FlaskPoint(fit.center, { 255, 255, 255 }, fit.r, 3);
